...
btn.addEventListener('click', () => {
    r.innerHTML = `<h5 class="text-center my-2" style="width:100%">Loading...</h5>`;
    fetch(url)
        ...
        .then(data => {
            ...
            r.innerHTML = '';
            match.forEach(item => {
                r.innerHTML += `<div class="col-sm-12 col-md-6">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <p>Runs : ${item.score[1].r}</p>
                <p>Wickets : ${item.score[1].w}</p>
                <p>Over : ${item.score[1].o}</p>
            </div>
            </div>
